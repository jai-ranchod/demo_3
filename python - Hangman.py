...
def hangman():
    word = get_valid_word()  # using our previously defined function to hold the secret word
    word_letters = set(word)  # holds the letters of the chosen word
    alphabet = set(string.ascii_uppercase)  # imports english alphabet
    used_letters = set()  # hold letters that have been guessed
    ...
    while len(word_letters) > 0 and lives > 0:
        # letters used
        print('You have',lives, 'lives remaining and you have used these letters: ', ' '.join(used_letters))  # join refers to concatonation

        # what the current word with dashes in blank spots
    ...
    if lives == 0:
        print('Sorry, you have died.  The word was: ',' '.join(word))
    else:
        print('You have correctly guessed: ', ' '.join(word))
