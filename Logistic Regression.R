...
#There are many methods for handling this issue as it is widely discussed in the data science community.  Box-Cox transformations, dropping data, adding a constant
#and average of half-min imputations are all options that are widely discussed.  Here, we will drop the data for simplicity.
